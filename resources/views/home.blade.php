...
@section('content')
    <div class="container">  
        <form class="form" method="GET" action="/search" role="search">
            @csrf
            <div class="form-group w-100 mb-3">
                <input type="text" name="search" class="form-control w-75 d-inline" id="search" placeholder="Kata Kunci">
    ...
    <div class="container">
            ...
            <a href="{{ route('print')}}" target="_blank" class="btn btn-sm btn-info">Cetak Daftar Pegawai</a>
            @if (session('status'))
